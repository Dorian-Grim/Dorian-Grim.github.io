import{S as me,i as de,s as pe,k as z,l as _,m as S,h as v,n as E,J as ia,b as D,K as Pe,L as M,H as V,M as be,N as Qe,I as $,q as A,a as h,r as T,c as x,G as p,u as K,O as se,P as na,Q as Y,o as ta,e as ue,d as W,f as oe,g as y,v as ce,R as Ze,p as I,y as fe,z as ge,A as we,T as Le,B as ve,U as $e,w as sa,V as ua,W as ea,X as aa,Y as oa}from"../chunks/index.845b4388.js";import{w as ie,r as ca}from"../chunks/index.104069cd.js";const la=[{questionNumber:"1.",question:`Se dă următorul algoritm:
...
Sunt apelate urmãtoarele:`,answers:["constructor – de patru ori, constructor de copiere – o datã, destructor – de patru ori;","constructor – de trei ori, constructor de copiere - de douã ori, destructor de cinci ori;","constructor – de douã ori, constructor de copiere – de douã ori, operator= - o datã, destructor – de patru ori;","constructor – de douã ori, constructor de copiere – o datã, operator= - de douã ori, destructor – de douã ori;","constructor – de douã ori, constructor de copiere – o datã, operator= - de douã ori, destructor – de patru ori."],correct_answers:[3]}],ga=[{questionNumber:"1.",question:`Fie următoarea clasă Java:
...
variabilei n şi readuce formularul la starea initiala;`],correct_answers:[3]},{questionNumber:"50.",question:"Proprietatea checked ataşat unui element radio dintr-un formular are ca efect?",answers:["Bifarea implicită a respectivului element radio;","Nu există acest atribut;","Trebuie ataşat obligatoriu la toate elementele radio din acelaşi grup;","Se foloseşte doar pentru elemente de tip checkbox;"],correct_answers:[1]}],Se={algoritmi_structuri_date:la,baze_de_date:ma,comert_electronic:da,cloud_computing:ba,criptografie:pa,programare_in_c:fa,programare_in_java:ga,programare_procedurala:wa,retele_de_calculatoare:va,sgbd:Na,sisteme_de_operare:qa,tehnici_avansate_programare:Ea,tehnologii_web:za},ee=[];Object.entries(Se).map(([,n])=>{n.forEach(e=>ee.push(e))});const le=n=>n==="random"?ee:Se[n]?Se[n]:null,Ae=ie(ee.length),_a=ie(1),Te=ie("random");ca(ee);const _e=ie([]),he=ie(0);function je(n,e,a){const r=n.slice();return r[6]=e[a],r}function Be(n){let e,a=n[6]+"",r,t,u;return{c(){e=z("option"),r=A(a),t=h(),this.h()},l(i){e=_(i,"OPTION",{});var o=S(e);r=T(o,a),t=x(o),o.forEach(v),this.h()},h(){e.__value=u=n[6],e.value=e.__value},m(i,o){D(i,e,o),p(e,r),p(e,t)},p(i,o){o&1&&a!==(a=i[6]+"")&&K(r,a),o&1&&u!==(u=i[6])&&(e.__value=u,e.value=e.__value)},d(i){i&&v(e)}}}function Ca(n){let e,a,r,t=n[0],u=[];for(let i=0;i<t.length;i+=1)u[i]=Be(je(n,t,i));return{c(){e=z("select");for(let i=0;i<u.length;i+=1)u[i].c();this.h()},l(i){e=_(i,"SELECT",{class:!0});var o=S(e);for(let s=0;s<u.length;s+=1)u[s].l(o);o.forEach(v),this.h()},h(){E(e,"class","svelte-1vgry9p"),n[1]===void 0&&ia(()=>n[3].call(e))},m(i,o){D(i,e,o);for(let s=0;s<u.length;s+=1)u[s]&&u[s].m(e,null);Pe(e,n[1]),a||(r=[M(e,"change",n[3]),M(e,"change",n[2])],a=!0)},p(i,[o]){if(o&1){t=i[0];let s;for(s=0;s<t.length;s+=1){const c=je(i,t,s);u[s]?u[s].p(c,o):(u[s]=Be(c),u[s].c(),u[s].m(e,null))}for(;s<u.length;s+=1)u[s].d(1);u.length=t.length}o&3&&Pe(e,i[1])},i:V,o:V,d(i){i&&v(e),be(u,i),a=!1,Qe(r)}}}function Sa(n,e,a){let r,t;$(n,Te,c=>a(4,r=c)),$(n,Ae,c=>a(5,t=c));let u,{courses:i=[]}=e;function o(){se(Te,r=u,r),se(Ae,t=le(r)?le(r).length:0,t)}function s(){u=na(this),a(1,u),a(0,i)}return n.$$set=c=>{"courses"in c&&a(0,i=c.courses)},[i,u,o,s]}class Aa extends me{constructor(e){super(),de(this,e,Sa,Ca,pe,{courses:0})}}function Me(n,e,a){const r=n.slice();return r[15]=e[a],r[17]=a,r}function ye(n){let e,a,r,t,u,i,o,s,c,l=n[15]+"",g,w,b,d;return{c(){e=z("div"),a=z("label"),r=z("input"),o=h(),s=z("span"),c=z("pre"),g=h(),this.h()},l(m){e=_(m,"DIV",{class:!0});var f=S(e);a=_(f,"LABEL",{class:!0});var N=S(a);r=_(N,"INPUT",{type:!0,name:!0,class:!0}),o=x(N),s=_(N,"SPAN",{class:!0});var q=S(s);c=_(q,"PRE",{class:!0});var B=S(c);B.forEach(v),q.forEach(v),N.forEach(v),g=x(f),f.forEach(v),this.h()},h(){E(r,"type",n[6]),E(r,"name",t="answers"+n[1]),r.value=u=n[15],r.disabled=i=n[0]||n[4],E(r,"class","svelte-1azzlzl"),E(c,"class","svelte-1azzlzl"),E(s,"class","svelte-1azzlzl"),E(a,"class","svelte-1azzlzl"),E(e,"class",w=n[6]+" "+n[3][n[17]]+" svelte-1azzlzl")},m(m,f){D(m,e,f),p(e,a),p(a,r),p(a,o),p(a,s),p(s,c),c.innerHTML=l,p(e,g),b||(d=M(r,"input",n[7]),b=!0)},p(m,f){f&2&&t!==(t="answers"+m[1])&&E(r,"name",t),f&4&&u!==(u=m[15])&&r.value!==u&&(r.value=u),f&17&&i!==(i=m[0]||m[4])&&(r.disabled=i),f&4&&l!==(l=m[15]+"")&&(c.innerHTML=l),f&8&&w!==(w=m[6]+" "+m[3][m[17]]+" svelte-1azzlzl")&&E(e,"class",w)},d(m){m&&v(e),b=!1,d()}}}function Ta(n){let e,a,r,t=n[1]+1+"",u,i,o,s,c,l,g,w,b=n[2],d=[];for(let m=0;m<b.length;m+=1)d[m]=ye(Me(n,b,m));return{c(){e=z("div"),a=z("div"),r=z("p"),u=A(t),i=A("."),o=h(),s=z("pre"),c=h(),l=z("div");for(let m=0;m<d.length;m+=1)d[m].c();this.h()},l(m){e=_(m,"DIV",{class:!0});var f=S(e);a=_(f,"DIV",{class:!0});var N=S(a);r=_(N,"P",{class:!0});var q=S(r);u=T(q,t),i=T(q,"."),q.forEach(v),o=x(N),s=_(N,"PRE",{class:!0});var B=S(s);B.forEach(v),N.forEach(v),c=x(f),l=_(f,"DIV",{class:!0});var H=S(l);for(let F=0;F<d.length;F+=1)d[F].l(H);H.forEach(v),f.forEach(v),this.h()},h(){E(r,"class","q-index svelte-1azzlzl"),E(s,"class","svelte-1azzlzl"),E(a,"class","question-title svelte-1azzlzl"),E(l,"class","answer-wrapper svelte-1azzlzl"),E(e,"class","question-wrapper svelte-1azzlzl")},m(m,f){D(m,e,f),p(e,a),p(a,r),p(r,u),p(r,i),p(a,o),p(a,s),s.innerHTML=n[5],p(e,c),p(e,l);for(let N=0;N<d.length;N+=1)d[N]&&d[N].m(l,null);g||(w=M(r,"click",Y(n[12])),g=!0)},p(m,[f]){if(f&2&&t!==(t=m[1]+1+"")&&K(u,t),f&223){b=m[2];let N;for(N=0;N<b.length;N+=1){const q=Me(m,b,N);d[N]?d[N].p(q,f):(d[N]=ye(q),d[N].c(),d[N].m(l,null))}for(;N<d.length;N+=1)d[N].d(1);d.length=b.length}},i:V,o:V,d(m){m&&v(e),be(d,m),g=!1,w()}}}function ha(n,e,a){let r;$(n,_e,q=>a(13,r=q));let{correct_answers:t=[]}=e,{showAnswers:u=!1}=e,{generateAnswered:i=!1}=e,{index:o=0}=e,{question:s="Ai uitat sa pui titlul intrebarii"}=e,{answers:c=["lipsa rasp 1","lipsa rasp 2","lipsa rasp 3","lipsa rasp 4"]}=e;const l=s;let g=t.length==1?"radio":"checkbox",w=[],b=[];se(_e,r[o]={userSelectedAnswers:w},r),i&&(c.forEach((q,B)=>{t.includes(q)&&(w.push(q),a(3,b[B]="correct",b))}),b=[...b]);let d=!1,m=!1;const f=q=>{w.push(q.target.defaultValue)},N=()=>{a(4,m=!0)};return n.$$set=q=>{"correct_answers"in q&&a(8,t=q.correct_answers),"showAnswers"in q&&a(0,u=q.showAnswers),"generateAnswered"in q&&a(9,i=q.generateAnswered),"index"in q&&a(1,o=q.index),"question"in q&&a(10,s=q.question),"answers"in q&&a(2,c=q.answers)},n.$$.update=()=>{n.$$.dirty&2335&&(u||m)&&(se(_e,r[o]={userSelectedAnswers:w},r),c.forEach((q,B)=>{const H=w.includes(q),F=t.includes(q);(F&&!H||!F&&H)&&a(11,d=!0),F&&a(3,b[B]="correct",b),H&&!F&&a(3,b[B]="wrong",b)}),a(3,b=[...b]),d&&he.update(q=>q+1))},[u,o,c,b,m,l,g,f,t,i,s,d,N]}class ra extends me{constructor(e){super(),de(this,e,ha,Ta,pe,{correct_answers:8,showAnswers:0,generateAnswered:9,index:1,question:10,answers:2})}}const xa=n=>Math.floor(Math.random()*n),Da=(n,e)=>{let a=[];for(;a.length<n;){let r=xa(e);a.includes(r)||a.push(r)}return a},Oa=n=>{for(let e=n.length-1;e>0;e--){let a=Math.floor(Math.random()*(e+1));[n[e],n[a]]=[n[a],n[e]]}return n},Ce=(n,e,a=!0,r=!1)=>{let t;a?t=Da(e,n.length):t=Array.from(Array(e).keys());let u=[];return t.forEach(i=>{let o={};o.question=n[i].question;let s=[...n[i].answers];o.correct_answers=[],n[i].correct_answers.forEach(c=>{o.correct_answers.push(n[i].answers[c-1])}),o.answers=r?Oa(s):s,u.push(o)}),u};function Fe(n){let e,a;return{c(){e=z("div"),a=A("Nu mai poti da submit, a expirat timpul! 🙃"),this.h()},l(r){e=_(r,"DIV",{class:!0});var t=S(e);a=T(t,"Nu mai poti da submit, a expirat timpul! 🙃"),t.forEach(v),this.h()},h(){E(e,"class","game-over-wrapper svelte-12773fi")},m(r,t){D(r,e,t),p(e,a)},d(r){r&&v(e)}}}function Ia(n){let e,a,r=Math.floor(n[1]/60)+"",t,u,i=(n[1]%60).toString().padStart(2,"0")+"",o,s,c=n[2]&&Fe();return{c(){c&&c.c(),e=h(),a=z("div"),t=A(r),u=A(":"),o=A(i),this.h()},l(l){c&&c.l(l),e=x(l),a=_(l,"DIV",{class:!0,style:!0});var g=S(a);t=T(g,r),u=T(g,":"),o=T(g,i),g.forEach(v),this.h()},h(){E(a,"class","timer-wrapper svelte-12773fi"),E(a,"style",s=n[0]?"background-color: grey":"")},m(l,g){c&&c.m(l,g),D(l,e,g),D(l,a,g),p(a,t),p(a,u),p(a,o)},p(l,[g]){l[2]?c||(c=Fe(),c.c(),c.m(e.parentNode,e)):c&&(c.d(1),c=null),g&2&&r!==(r=Math.floor(l[1]/60)+"")&&K(t,r),g&2&&i!==(i=(l[1]%60).toString().padStart(2,"0")+"")&&K(o,i),g&1&&s!==(s=l[0]?"background-color: grey":"")&&E(a,"style",s)},i:V,o:V,d(l){c&&c.d(l),l&&v(e),l&&v(a)}}}function Ra(n,e,a){let r=null,t=60*60,u=!1,{formSubmitted:i=!1}=e;return ta(()=>{a(3,r=setInterval(()=>{a(1,t-=1)},1e3))}),n.$$set=o=>{"formSubmitted"in o&&a(0,i=o.formSubmitted)},n.$$.update=()=>{n.$$.dirty&11&&(t===0||i)&&(clearInterval(r),a(3,r=null),i||a(2,u=!0))},[i,t,u,r]}class Pa extends me{constructor(e){super(),de(this,e,Ra,Ia,pe,{formSubmitted:0})}}function Ue(n,e,a){const r=n.slice();return r[23]=e[a],r[25]=a,r}function ke(n,e,a){const r=n.slice();return r[23]=e[a],r[25]=a,r}function La(n){let e,a,r,t,u,i,o,s=n[4]&&He(n),c=n[0],l=[];for(let d=0;d<c.length;d+=1)l[d]=We(Ue(n,c,d));const g=d=>W(l[d],1,1,()=>{l[d]=null});let w=!n[2]&&Ve(),b=n[2]&&Je(n);return{c(){s&&s.c(),e=h(),a=z("form");for(let d=0;d<l.length;d+=1)l[d].c();r=h(),w&&w.c(),t=h(),b&&b.c(),this.h()},l(d){s&&s.l(d),e=x(d),a=_(d,"FORM",{style:!0});var m=S(a);for(let f=0;f<l.length;f+=1)l[f].l(m);r=x(m),w&&w.l(m),t=x(m),b&&b.l(m),m.forEach(v),this.h()},h(){I(a,"position","relative")},m(d,m){s&&s.m(d,m),D(d,e,m),D(d,a,m);for(let f=0;f<l.length;f+=1)l[f]&&l[f].m(a,null);p(a,r),w&&w.m(a,null),p(a,t),b&&b.m(a,null),u=!0,i||(o=M(a,"submit",Y(n[11])),i=!0)},p(d,m){if(d[4]?s?(s.p(d,m),m&16&&y(s,1)):(s=He(d),s.c(),y(s,1),s.m(e.parentNode,e)):s&&(ce(),W(s,1,1,()=>{s=null}),oe()),m&5){c=d[0];let f;for(f=0;f<c.length;f+=1){const N=Ue(d,c,f);l[f]?(l[f].p(N,m),y(l[f],1)):(l[f]=We(N),l[f].c(),y(l[f],1),l[f].m(a,r))}for(ce(),f=c.length;f<l.length;f+=1)g(f);oe()}d[2]?w&&(w.d(1),w=null):w||(w=Ve(),w.c(),w.m(a,t)),d[2]?b?b.p(d,m):(b=Je(d),b.c(),b.m(a,null)):b&&(b.d(1),b=null)},i(d){if(!u){y(s);for(let m=0;m<c.length;m+=1)y(l[m]);u=!0}},o(d){W(s),l=l.filter(Boolean);for(let m=0;m<l.length;m+=1)W(l[m]);u=!1},d(d){s&&s.d(d),d&&v(e),d&&v(a),be(l,d),w&&w.d(),b&&b.d(),i=!1,o()}}}function ja(n){let e,a,r,t,u,i,o,s,c,l,g,w,b,d,m,f,N,q,B,H,F,O,ae,X,re,U,G,Ne,qe,J,Ee,Q,ze,xe;c=new Aa({props:{courses:n[9]}});let R=n[7]>=10&&Ge(n),P=n[7]>=20&&Ke(n),L=n[7]>=40&&Ye(n);return{c(){e=z("button"),a=A("vezi totul"),r=h(),t=z("form"),u=z("div"),i=z("p"),o=A("Alege un curs anume sau random din toate:"),s=h(),fe(c.$$.fragment),l=h(),g=z("div"),w=z("p"),b=A("Vrei timer?"),d=h(),m=z("input"),f=h(),N=z("p"),q=A("Alege cate intrebari vrei sa primesti, nr max pt materie "),B=A(n[7]),H=A(":"),F=h(),O=z("input"),ae=h(),R&&R.c(),X=h(),P&&P.c(),re=h(),L&&L.c(),U=h(),G=z("button"),Ne=A("MAX"),qe=h(),J=z("button"),Ee=A("Start"),this.h()},l(C){e=_(C,"BUTTON",{style:!0});var k=S(e);a=T(k,"vezi totul"),k.forEach(v),r=x(C),t=_(C,"FORM",{});var Z=S(t);u=_(Z,"DIV",{style:!0});var ne=S(u);i=_(ne,"P",{});var De=S(i);o=T(De,"Alege un curs anume sau random din toate:"),De.forEach(v),s=x(ne),ge(c.$$.fragment,ne),ne.forEach(v),l=x(Z),g=_(Z,"DIV",{});var j=S(g);w=_(j,"P",{});var Oe=S(w);b=T(Oe,"Vrei timer?"),Oe.forEach(v),d=x(j),m=_(j,"INPUT",{type:!0,class:!0}),f=x(j),N=_(j,"P",{});var te=S(N);q=T(te,"Alege cate intrebari vrei sa primesti, nr max pt materie "),B=T(te,n[7]),H=T(te,":"),te.forEach(v),F=x(j),O=_(j,"INPUT",{style:!0,type:!0,min:!0,max:!0,class:!0}),ae=x(j),R&&R.l(j),X=x(j),P&&P.l(j),re=x(j),L&&L.l(j),U=x(j),G=_(j,"BUTTON",{class:!0});var Ie=S(G);Ne=T(Ie,"MAX"),Ie.forEach(v),j.forEach(v),qe=x(Z),J=_(Z,"BUTTON",{type:!0,class:!0,style:!0});var Re=S(J);Ee=T(Re,"Start"),Re.forEach(v),Z.forEach(v),this.h()},h(){I(e,"margin-bottom","20px"),I(u,"margin-bottom","20px"),E(m,"type","checkbox"),E(m,"class","svelte-n1kvot"),I(O,"min-width","50px"),I(O,"padding","7px 20px"),I(O,"font-size","16px"),I(O,"margin-top","10px"),E(O,"type","number"),E(O,"min","1"),E(O,"max",n[7]),E(O,"class","svelte-n1kvot"),E(G,"class","input-btn svelte-n1kvot"),E(J,"type","submit"),E(J,"class","submit-btn svelte-n1kvot"),I(J,"margin-left","0")},m(C,k){D(C,e,k),p(e,a),D(C,r,k),D(C,t,k),p(t,u),p(u,i),p(i,o),p(u,s),we(c,u,null),p(t,l),p(t,g),p(g,w),p(w,b),p(g,d),p(g,m),m.checked=n[4],p(g,f),p(g,N),p(N,q),p(N,B),p(N,H),p(g,F),p(g,O),Le(O,n[3]),p(g,ae),R&&R.m(g,null),p(g,X),P&&P.m(g,null),p(g,re),L&&L.m(g,null),p(g,U),p(g,G),p(G,Ne),p(t,qe),p(t,J),p(J,Ee),Q=!0,ze||(xe=[M(e,"click",n[12]),M(m,"change",n[13]),M(O,"input",n[14]),M(O,"change",n[15]),M(G,"click",Y(n[19])),M(t,"submit",Y(n[10]))],ze=!0)},p(C,k){k&16&&(m.checked=C[4]),(!Q||k&128)&&K(B,C[7]),(!Q||k&128)&&E(O,"max",C[7]),k&8&&Ze(O.value)!==C[3]&&Le(O,C[3]),C[7]>=10?R?R.p(C,k):(R=Ge(C),R.c(),R.m(g,X)):R&&(R.d(1),R=null),C[7]>=20?P?P.p(C,k):(P=Ke(C),P.c(),P.m(g,re)):P&&(P.d(1),P=null),C[7]>=40?L?L.p(C,k):(L=Ye(C),L.c(),L.m(g,U)):L&&(L.d(1),L=null)},i(C){Q||(y(c.$$.fragment,C),Q=!0)},o(C){W(c.$$.fragment,C),Q=!1},d(C){C&&v(e),C&&v(r),C&&v(t),ve(c),R&&R.d(),P&&P.d(),L&&L.d(),ze=!1,Qe(xe)}}}function Ba(n){let e,a,r=n[6],t=[];for(let i=0;i<r.length;i+=1)t[i]=Xe(ke(n,r,i));const u=i=>W(t[i],1,1,()=>{t[i]=null});return{c(){for(let i=0;i<t.length;i+=1)t[i].c();e=ue()},l(i){for(let o=0;o<t.length;o+=1)t[o].l(i);e=ue()},m(i,o){for(let s=0;s<t.length;s+=1)t[s]&&t[s].m(i,o);D(i,e,o),a=!0},p(i,o){if(o&100){r=i[6];let s;for(s=0;s<r.length;s+=1){const c=ke(i,r,s);t[s]?(t[s].p(c,o),y(t[s],1)):(t[s]=Xe(c),t[s].c(),y(t[s],1),t[s].m(e.parentNode,e))}for(ce(),s=r.length;s<t.length;s+=1)u(s);oe()}},i(i){if(!a){for(let o=0;o<r.length;o+=1)y(t[o]);a=!0}},o(i){t=t.filter(Boolean);for(let o=0;o<t.length;o+=1)W(t[o]);a=!1},d(i){be(t,i),i&&v(e)}}}function He(n){let e,a;return e=new Pa({props:{formSubmitted:n[2]}}),{c(){fe(e.$$.fragment)},l(r){ge(e.$$.fragment,r)},m(r,t){we(e,r,t),a=!0},p(r,t){const u={};t&4&&(u.formSubmitted=r[2]),e.$set(u)},i(r){a||(y(e.$$.fragment,r),a=!0)},o(r){W(e.$$.fragment,r),a=!1},d(r){ve(e,r)}}}function We(n){let e,a,r;const t=[n[23],{index:n[25]}];function u(o){n[20](o)}let i={};for(let o=0;o<t.length;o+=1)i=$e(i,t[o]);return n[2]!==void 0&&(i.showAnswers=n[2]),e=new ra({props:i}),sa.push(()=>ua(e,"showAnswers",u)),{c(){fe(e.$$.fragment)},l(o){ge(e.$$.fragment,o)},m(o,s){we(e,o,s),r=!0},p(o,s){const c=s&1?ea(t,[aa(o[23]),t[1]]):{};!a&&s&4&&(a=!0,c.showAnswers=o[2],oa(()=>a=!1)),e.$set(c)},i(o){r||(y(e.$$.fragment,o),r=!0)},o(o){W(e.$$.fragment,o),r=!1},d(o){ve(e,o)}}}function Ve(n){let e,a;return{c(){e=z("button"),a=A("Submit form"),this.h()},l(r){e=_(r,"BUTTON",{type:!0,class:!0});var t=S(e);a=T(t,"Submit form"),t.forEach(v),this.h()},h(){E(e,"type","submit"),E(e,"class","submit-btn svelte-n1kvot")},m(r,t){D(r,e,t),p(e,a)},d(r){r&&v(e)}}}function Je(n){let e,a,r,t,u,i=n[3]-n[8]+"",o,s,c,l,g;return{c(){e=z("button"),a=A("Genereaza inca un quizz"),r=h(),t=z("h4"),u=A("Ai nimerit "),o=A(i),s=A(" din "),c=A(n[3]),this.h()},l(w){e=_(w,"BUTTON",{type:!0,class:!0,style:!0});var b=S(e);a=T(b,"Genereaza inca un quizz"),b.forEach(v),r=x(w),t=_(w,"H4",{style:!0});var d=S(t);u=T(d,"Ai nimerit "),o=T(d,i),s=T(d," din "),c=T(d,n[3]),d.forEach(v),this.h()},h(){E(e,"type","button"),E(e,"class","submit-btn svelte-n1kvot"),I(e,"position","sticky"),I(e,"bottom","20px"),I(t,"position","absolute"),I(t,"bottom","0"),I(t,"right","0"),I(t,"background-color","grey"),I(t,"padding","10px 20px"),I(t,"color","white"),I(t,"font-weight","600"),I(t,"font-size","20px")},m(w,b){D(w,e,b),p(e,a),D(w,r,b),D(w,t,b),p(t,u),p(t,o),p(t,s),p(t,c),l||(g=M(e,"click",n[21]),l=!0)},p(w,b){b&264&&i!==(i=w[3]-w[8]+"")&&K(o,i),b&8&&K(c,w[3])},d(w){w&&v(e),w&&v(r),w&&v(t),l=!1,g()}}}function Ge(n){let e,a,r,t;return{c(){e=z("button"),a=A("select 10"),this.h()},l(u){e=_(u,"BUTTON",{class:!0});var i=S(e);a=T(i,"select 10"),i.forEach(v),this.h()},h(){E(e,"class","input-btn svelte-n1kvot")},m(u,i){D(u,e,i),p(e,a),r||(t=M(e,"click",Y(n[16])),r=!0)},p:V,d(u){u&&v(e),r=!1,t()}}}function Ke(n){let e,a,r,t;return{c(){e=z("button"),a=A("select 20"),this.h()},l(u){e=_(u,"BUTTON",{class:!0});var i=S(e);a=T(i,"select 20"),i.forEach(v),this.h()},h(){E(e,"class","input-btn svelte-n1kvot")},m(u,i){D(u,e,i),p(e,a),r||(t=M(e,"click",Y(n[17])),r=!0)},p:V,d(u){u&&v(e),r=!1,t()}}}function Ye(n){let e,a,r,t;return{c(){e=z("button"),a=A("select 40"),this.h()},l(u){e=_(u,"BUTTON",{class:!0});var i=S(e);a=T(i,"select 40"),i.forEach(v),this.h()},h(){E(e,"class","input-btn svelte-n1kvot")},m(u,i){D(u,e,i),p(e,a),r||(t=M(e,"click",Y(n[18])),r=!0)},p:V,d(u){u&&v(e),r=!1,t()}}}function Xe(n){let e,a;const r=[n[23],{index:n[25]},{showAnswers:n[2]},{generateAnswered:n[5]}];let t={};for(let u=0;u<r.length;u+=1)t=$e(t,r[u]);return e=new ra({props:t}),{c(){fe(e.$$.fragment)},l(u){ge(e.$$.fragment,u)},m(u,i){we(e,u,i),a=!0},p(u,i){const o=i&100?ea(r,[i&64&&aa(u[23]),r[1],i&4&&{showAnswers:u[2]},i&32&&{generateAnswered:u[5]}]):{};e.$set(o)},i(u){a||(y(e.$$.fragment,u),a=!0)},o(u){W(e.$$.fragment,u),a=!1},d(u){ve(e,u)}}}function Ma(n){let e,a,r,t;const u=[Ba,ja,La],i=[];function o(s,c){return s[5]?0:s[1]?2:1}return e=o(n),a=i[e]=u[e](n),{c(){a.c(),r=ue()},l(s){a.l(s),r=ue()},m(s,c){i[e].m(s,c),D(s,r,c),t=!0},p(s,[c]){let l=e;e=o(s),e===l?i[e].p(s,c):(ce(),W(i[l],1,1,()=>{i[l]=null}),oe(),a=i[e],a?a.p(s,c):(a=i[e]=u[e](s),a.c()),y(a,1),a.m(r.parentNode,r))},i(s){t||(y(a),t=!0)},o(s){W(a),t=!1},d(s){i[e].d(s),s&&v(r)}}}function ya(n,e,a){let r,t,u;$(n,Te,U=>a(22,r=U)),$(n,Ae,U=>a(7,t=U)),$(n,he,U=>a(8,u=U));let i=ee;const o=["random","algoritmi_structuri_date","baze_de_date","cloud_computing","comert_electronic","criptografie","programare_in_c","programare_in_java","programare_procedurala","retele_de_calculatoare","sgbd","sisteme_de_operare","tehnici_avansate_programare","tehnologii_web"];let s=!1,c=!1,l=1,g=!0;function w(){if(r==="random"){a(0,i=Ce(ee,l)),a(1,s=!0);return}a(0,i=le(r)),a(0,i=Ce(i,l)),a(1,s=!0)}function b(U){a(2,c=!0)}let d=!1,m;function f(){a(0,i=le(r)),a(6,m=Ce(i,i.length,!1)),a(5,d=!0),a(2,c=!0)}function N(){g=this.checked,a(4,g)}function q(){l=Ze(this.value),a(3,l)}const B=()=>_a.set(l),H=()=>a(3,l=10),F=()=>a(3,l=20),O=()=>a(3,l=40),ae=()=>a(3,l=t);function X(U){c=U,a(2,c)}return[i,s,c,l,g,d,m,t,u,o,w,b,f,N,q,B,H,F,O,ae,X,()=>{a(2,c=!1),a(1,s=!1),he.update(U=>0)}]}class ka extends me{constructor(e){super(),de(this,e,ya,Ma,pe,{})}}export{ka as default};
