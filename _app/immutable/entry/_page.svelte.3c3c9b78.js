import{S as le,i as me,s as de,k as _,l as z,m as S,h as v,n as E,J as Ze,b as h,K as Oe,L as U,H as V,M as pe,N as Ge,I as X,q as A,a as O,r as T,c as I,G as g,u as J,O as oe,P as $e,Q as G,o as ea,e as Q,d as H,f as be,g as B,v as fe,R as Ke,y as ee,z as ae,p as R,A as re,B as ie,T as Ie,U as Ce,V as Se,W as Ae,w as Ye,X as Xe,Y as Qe}from"../chunks/index.6980aea7.js";import{w as ne,r as aa}from"../chunks/index.c3d26902.js";const ra=[{questionNumber:"1.",question:`Se dă următorul algoritm:
...
Sunt apelate urmãtoarele:`,answers:["constructor – de patru ori, constructor de copiere – o datã, destructor – de patru ori;","constructor – de trei ori, constructor de copiere - de douã ori, destructor de cinci ori;","constructor – de douã ori, constructor de copiere – de douã ori, operator= - o datã, destructor – de patru ori;","constructor – de douã ori, constructor de copiere – o datã, operator= - de douã ori, destructor – de douã ori;","constructor – de douã ori, constructor de copiere – o datã, operator= - de douã ori, destructor – de patru ori."],correct_answers:[3]}],oa=[{questionNumber:"1.",question:`Fie următoarea clasă Java:
...
variabilei n şi readuce formularul la starea initiala;`],correct_answers:[3]},{questionNumber:"50.",question:"Proprietatea checked ataşat unui element radio dintr-un formular are ca efect?",answers:["Bifarea implicită a respectivului element radio;","Nu există acest atribut;","Trebuie ataşat obligatoriu la toate elementele radio din acelaşi grup;","Se foloseşte doar pentru elemente de tip checkbox;"],correct_answers:[1]}],qe={algoritmi_structuri_date:ra,baze_de_date:ia,comert_electronic:na,cloud_computing:sa,criptografie:ta,programare_in_c:ua,programare_in_java:oa,programare_procedurala:ca,retele_de_calculatoare:la,sgbd:ma,sisteme_de_operare:da,tehnici_avansate_programare:pa,tehnologii_web:ba},Z=[];Object.entries(qe).map(([,t])=>{t.forEach(e=>Z.push(e))});const ce=t=>t==="random"?Z:qe[t]?qe[t]:null,Ee=ne(Z.length),fa=ne(1),_e=ne("random");aa(Z);const ve=ne([]),ze=ne(0);function Re(t,e,a){const r=t.slice();return r[6]=e[a],r}function Pe(t){let e,a=t[6]+"",r,n,o;return{c(){e=_("option"),r=A(a),n=O(),this.h()},l(i){e=z(i,"OPTION",{});var u=S(e);r=T(u,a),n=I(u),u.forEach(v),this.h()},h(){e.__value=o=t[6],e.value=e.__value},m(i,u){h(i,e,u),g(e,r),g(e,n)},p(i,u){u&1&&a!==(a=i[6]+"")&&J(r,a),u&1&&o!==(o=i[6])&&(e.__value=o,e.value=e.__value)},d(i){i&&v(e)}}}function ga(t){let e,a,r,n=t[0],o=[];for(let i=0;i<n.length;i+=1)o[i]=Pe(Re(t,n,i));return{c(){e=_("select");for(let i=0;i<o.length;i+=1)o[i].c();this.h()},l(i){e=z(i,"SELECT",{class:!0});var u=S(e);for(let s=0;s<o.length;s+=1)o[s].l(u);u.forEach(v),this.h()},h(){E(e,"class","svelte-1vgry9p"),t[1]===void 0&&Ze(()=>t[3].call(e))},m(i,u){h(i,e,u);for(let s=0;s<o.length;s+=1)o[s]&&o[s].m(e,null);Oe(e,t[1]),a||(r=[U(e,"change",t[3]),U(e,"change",t[2])],a=!0)},p(i,[u]){if(u&1){n=i[0];let s;for(s=0;s<n.length;s+=1){const c=Re(i,n,s);o[s]?o[s].p(c,u):(o[s]=Pe(c),o[s].c(),o[s].m(e,null))}for(;s<o.length;s+=1)o[s].d(1);o.length=n.length}u&3&&Oe(e,i[1])},i:V,o:V,d(i){i&&v(e),pe(o,i),a=!1,Ge(r)}}}function wa(t,e,a){let r,n;X(t,_e,c=>a(4,r=c)),X(t,Ee,c=>a(5,n=c));let o,{courses:i=[]}=e;function u(){oe(_e,r=o,r),oe(Ee,n=ce(r)?ce(r).length:0,n)}function s(){o=$e(this),a(1,o),a(0,i)}return t.$$set=c=>{"courses"in c&&a(0,i=c.courses)},[i,o,u,s]}class va extends le{constructor(e){super(),me(this,e,wa,ga,de,{courses:0})}}function Le(t,e,a){const r=t.slice();return r[16]=e[a],r[18]=a,r}function je(t){let e,a,r,n,o,i,u,s,c,l=t[16]+"",w,b,f,m;return{c(){e=_("div"),a=_("label"),r=_("input"),u=O(),s=_("span"),c=_("pre"),w=O(),this.h()},l(d){e=z(d,"DIV",{class:!0});var N=S(e);a=z(N,"LABEL",{class:!0});var p=S(a);r=z(p,"INPUT",{type:!0,name:!0,class:!0}),u=I(p),s=z(p,"SPAN",{class:!0});var x=S(s);c=z(x,"PRE",{class:!0});var q=S(c);q.forEach(v),x.forEach(v),p.forEach(v),w=I(N),N.forEach(v),this.h()},h(){E(r,"type",t[6]),E(r,"name",n="answers"+t[1]),r.value=o=t[16],r.disabled=i=t[0]||t[4],E(r,"class","svelte-1azzlzl"),E(c,"class","svelte-1azzlzl"),E(s,"class","svelte-1azzlzl"),E(a,"class","svelte-1azzlzl"),E(e,"class",b=t[6]+" "+t[3][t[18]]+" svelte-1azzlzl")},m(d,N){h(d,e,N),g(e,a),g(a,r),g(a,u),g(a,s),g(s,c),c.innerHTML=l,g(e,w),f||(m=U(r,"input",t[7]),f=!0)},p(d,N){N&2&&n!==(n="answers"+d[1])&&E(r,"name",n),N&4&&o!==(o=d[16])&&r.value!==o&&(r.value=o),N&17&&i!==(i=d[0]||d[4])&&(r.disabled=i),N&4&&l!==(l=d[16]+"")&&(c.innerHTML=l),N&8&&b!==(b=d[6]+" "+d[3][d[18]]+" svelte-1azzlzl")&&E(e,"class",b)},d(d){d&&v(e),f=!1,m()}}}function Na(t){let e,a,r,n=t[1]+1+"",o,i,u,s,c,l,w,b,f=t[2],m=[];for(let d=0;d<f.length;d+=1)m[d]=je(Le(t,f,d));return{c(){e=_("div"),a=_("div"),r=_("p"),o=A(n),i=A("."),u=O(),s=_("pre"),c=O(),l=_("div");for(let d=0;d<m.length;d+=1)m[d].c();this.h()},l(d){e=z(d,"DIV",{class:!0});var N=S(e);a=z(N,"DIV",{class:!0});var p=S(a);r=z(p,"P",{class:!0});var x=S(r);o=T(x,n),i=T(x,"."),x.forEach(v),u=I(p),s=z(p,"PRE",{class:!0});var q=S(s);q.forEach(v),p.forEach(v),c=I(N),l=z(N,"DIV",{class:!0});var M=S(l);for(let y=0;y<m.length;y+=1)m[y].l(M);M.forEach(v),N.forEach(v),this.h()},h(){E(r,"class","q-index svelte-1azzlzl"),E(s,"class","svelte-1azzlzl"),E(a,"class","question-title svelte-1azzlzl"),E(l,"class","answer-wrapper svelte-1azzlzl"),E(e,"class","question-wrapper svelte-1azzlzl")},m(d,N){h(d,e,N),g(e,a),g(a,r),g(r,o),g(r,i),g(a,u),g(a,s),s.innerHTML=t[5],g(e,c),g(e,l);for(let p=0;p<m.length;p+=1)m[p]&&m[p].m(l,null);w||(b=U(r,"click",G(t[14])),w=!0)},p(d,[N]){if(N&2&&n!==(n=d[1]+1+"")&&J(o,n),N&223){f=d[2];let p;for(p=0;p<f.length;p+=1){const x=Le(d,f,p);m[p]?m[p].p(x,N):(m[p]=je(x),m[p].c(),m[p].m(l,null))}for(;p<m.length;p+=1)m[p].d(1);m.length=f.length}},i:V,o:V,d(d){d&&v(e),pe(m,d),w=!1,b()}}}function qa(t,e,a){let r;X(t,ve,q=>a(15,r=q));let{correct_answers:n=[]}=e,{showAnswers:o=!1}=e,{generateAnswered:i=!1}=e,{index:u=0}=e,{question:s="Ai uitat sa pui titlul intrebarii"}=e,{answers:c=["lipsa rasp 1","lipsa rasp 2","lipsa rasp 3","lipsa rasp 4"]}=e;const l=s;let w=n.length==1?"radio":"checkbox",b=w=="radio"?"":[],f=[];oe(ve,r[u]={userSelectedAnswers:b},r),i&&(c.forEach((q,M)=>{n.includes(q)&&(a(12,b=q),a(3,f[M]="correct",f))}),f=[...f]);let m=!1,d=!1,{val2:N}=e;const p=q=>{a(8,N=w.match(/^(radio|checkbox)$/)?+q.target.value:q.target.value)},x=()=>{a(4,d=!0)};return t.$$set=q=>{"correct_answers"in q&&a(9,n=q.correct_answers),"showAnswers"in q&&a(0,o=q.showAnswers),"generateAnswered"in q&&a(10,i=q.generateAnswered),"index"in q&&a(1,u=q.index),"question"in q&&a(11,s=q.question),"answers"in q&&a(2,c=q.answers),"val2"in q&&a(8,N=q.val2)},t.$$.update=()=>{t.$$.dirty&12831&&(o||d)&&(oe(ve,r[u]={userSelectedAnswers:b},r),c.forEach((q,M)=>{const y=n.length==1?b===q:b.includes(q),F=n.includes(q);(F&&!y||!F&&y)&&a(13,m=!0),F&&a(3,f[M]="correct",f),y&&!F&&a(3,f[M]="wrong",f)}),a(3,f=[...f]),m&&ze.update(q=>q+1))},[o,u,c,f,d,l,w,p,N,n,i,s,b,m,x]}class Ea extends le{constructor(e){super(),me(this,e,qa,Na,de,{correct_answers:9,showAnswers:0,generateAnswered:10,index:1,question:11,answers:2,val2:8})}}const _a=t=>Math.floor(Math.random()*t),za=(t,e)=>{let a=[];for(;a.length<t;){let r=_a(e);a.includes(r)||a.push(r)}return a},Ca=t=>{for(let e=t.length-1;e>0;e--){let a=Math.floor(Math.random()*(e+1));[t[e],t[a]]=[t[a],t[e]]}return t},Ne=(t,e,a=!0,r=!1)=>{let n;a?n=za(e,t.length):n=Array.from(Array(e).keys());let o=[];return n.forEach(i=>{let u={};u.question=t[i].question;let s=[...t[i].answers];u.correct_answers=[],t[i].correct_answers.forEach(c=>{u.correct_answers.push(t[i].answers[c-1])}),u.answers=r?Ca(s):s,o.push(u)}),o};function Be(t){let e,a;return{c(){e=_("div"),a=A("Nu mai poti da submit, a expirat timpul! 🙃"),this.h()},l(r){e=z(r,"DIV",{class:!0});var n=S(e);a=T(n,"Nu mai poti da submit, a expirat timpul! 🙃"),n.forEach(v),this.h()},h(){E(e,"class","game-over-wrapper svelte-12773fi")},m(r,n){h(r,e,n),g(e,a)},d(r){r&&v(e)}}}function Sa(t){let e,a,r=Math.floor(t[1]/60)+"",n,o,i=(t[1]%60).toString().padStart(2,"0")+"",u,s,c=t[2]&&Be();return{c(){c&&c.c(),e=O(),a=_("div"),n=A(r),o=A(":"),u=A(i),this.h()},l(l){c&&c.l(l),e=I(l),a=z(l,"DIV",{class:!0,style:!0});var w=S(a);n=T(w,r),o=T(w,":"),u=T(w,i),w.forEach(v),this.h()},h(){E(a,"class","timer-wrapper svelte-12773fi"),E(a,"style",s=t[0]?"background-color: grey":"")},m(l,w){c&&c.m(l,w),h(l,e,w),h(l,a,w),g(a,n),g(a,o),g(a,u)},p(l,[w]){l[2]?c||(c=Be(),c.c(),c.m(e.parentNode,e)):c&&(c.d(1),c=null),w&2&&r!==(r=Math.floor(l[1]/60)+"")&&J(n,r),w&2&&i!==(i=(l[1]%60).toString().padStart(2,"0")+"")&&J(u,i),w&1&&s!==(s=l[0]?"background-color: grey":"")&&E(a,"style",s)},i:V,o:V,d(l){c&&c.d(l),l&&v(e),l&&v(a)}}}function Aa(t,e,a){let r=null,n=60*60,o=!1,{formSubmitted:i=!1}=e;return ea(()=>{a(3,r=setInterval(()=>{a(1,n-=1)},1e3))}),t.$$set=u=>{"formSubmitted"in u&&a(0,i=u.formSubmitted)},t.$$.update=()=>{t.$$.dirty&11&&(n===0||i)&&(clearInterval(r),a(3,r=null),i||a(2,o=!0))},[i,n,o,r]}class Ta extends le{constructor(e){super(),me(this,e,Aa,Sa,de,{formSubmitted:0})}}function Me(t,e,a){const r=t.slice();return r[22]=e[a],r[24]=a,r}function ye(t,e,a){const r=t.slice();return r[22]=e[a],r[24]=a,r}function ha(t){let e,a,r,n,o,i,u,s;e=new Ta({props:{formSubmitted:t[2]}});let c=t[0],l=[];for(let m=0;m<c.length;m+=1)l[m]=Fe(Me(t,c,m));const w=m=>H(l[m],1,1,()=>{l[m]=null});let b=!t[2]&&Ue(),f=t[2]&&ke(t);return{c(){ee(e.$$.fragment),a=O(),r=_("form");for(let m=0;m<l.length;m+=1)l[m].c();n=O(),b&&b.c(),o=O(),f&&f.c(),this.h()},l(m){ae(e.$$.fragment,m),a=I(m),r=z(m,"FORM",{style:!0});var d=S(r);for(let N=0;N<l.length;N+=1)l[N].l(d);n=I(d),b&&b.l(d),o=I(d),f&&f.l(d),d.forEach(v),this.h()},h(){R(r,"position","relative")},m(m,d){re(e,m,d),h(m,a,d),h(m,r,d);for(let N=0;N<l.length;N+=1)l[N]&&l[N].m(r,null);g(r,n),b&&b.m(r,null),g(r,o),f&&f.m(r,null),i=!0,u||(s=U(r,"submit",G(t[10])),u=!0)},p(m,d){const N={};if(d&4&&(N.formSubmitted=m[2]),e.$set(N),d&5){c=m[0];let p;for(p=0;p<c.length;p+=1){const x=Me(m,c,p);l[p]?(l[p].p(x,d),B(l[p],1)):(l[p]=Fe(x),l[p].c(),B(l[p],1),l[p].m(r,n))}for(fe(),p=c.length;p<l.length;p+=1)w(p);be()}m[2]?b&&(b.d(1),b=null):b||(b=Ue(),b.c(),b.m(r,o)),m[2]?f?f.p(m,d):(f=ke(m),f.c(),f.m(r,null)):f&&(f.d(1),f=null)},i(m){if(!i){B(e.$$.fragment,m);for(let d=0;d<c.length;d+=1)B(l[d]);i=!0}},o(m){H(e.$$.fragment,m),l=l.filter(Boolean);for(let d=0;d<l.length;d+=1)H(l[d]);i=!1},d(m){ie(e,m),m&&v(a),m&&v(r),pe(l,m),b&&b.d(),f&&f.d(),u=!1,s()}}}function xa(t){let e,a,r,n,o,i,u,s,c,l,w,b,f,m,d,N,p,x,q,M,y,F,$,te,D,ge,K,we,Te;c=new va({props:{courses:t[8]}});let P=t[6]>=10&&He(t),L=t[6]>=20&&We(t),j=t[6]>=40&&Ve(t);return{c(){e=_("button"),a=A("vezi totul"),r=O(),n=_("form"),o=_("div"),i=_("p"),u=A("Alege un curs anume sau random din toate:"),s=O(),ee(c.$$.fragment),l=O(),w=_("div"),b=_("p"),f=A("Alege cate intrebari vrei sa primesti, nr max pt materie "),m=A(t[6]),d=A(":"),N=O(),p=_("input"),x=O(),P&&P.c(),q=O(),L&&L.c(),M=O(),j&&j.c(),y=O(),F=_("button"),$=A("MAX"),te=O(),D=_("button"),ge=A("Start"),this.h()},l(C){e=z(C,"BUTTON",{style:!0});var k=S(e);a=T(k,"vezi totul"),k.forEach(v),r=I(C),n=z(C,"FORM",{});var Y=S(n);o=z(Y,"DIV",{style:!0});var se=S(o);i=z(se,"P",{});var he=S(i);u=T(he,"Alege un curs anume sau random din toate:"),he.forEach(v),s=I(se),ae(c.$$.fragment,se),se.forEach(v),l=I(Y),w=z(Y,"DIV",{});var W=S(w);b=z(W,"P",{});var ue=S(b);f=T(ue,"Alege cate intrebari vrei sa primesti, nr max pt materie "),m=T(ue,t[6]),d=T(ue,":"),ue.forEach(v),N=I(W),p=z(W,"INPUT",{style:!0,type:!0,min:!0,max:!0,class:!0}),x=I(W),P&&P.l(W),q=I(W),L&&L.l(W),M=I(W),j&&j.l(W),y=I(W),F=z(W,"BUTTON",{class:!0});var xe=S(F);$=T(xe,"MAX"),xe.forEach(v),W.forEach(v),te=I(Y),D=z(Y,"BUTTON",{type:!0,class:!0,style:!0});var De=S(D);ge=T(De,"Start"),De.forEach(v),Y.forEach(v),this.h()},h(){R(e,"margin-bottom","20px"),R(o,"margin-bottom","20px"),R(p,"min-width","50px"),R(p,"padding","7px 20px"),R(p,"font-size","16px"),R(p,"margin-top","10px"),E(p,"type","number"),E(p,"min","1"),E(p,"max",t[6]),E(p,"class","svelte-n1kvot"),E(F,"class","input-btn svelte-n1kvot"),E(D,"type","submit"),E(D,"class","submit-btn svelte-n1kvot"),R(D,"margin-left","0")},m(C,k){h(C,e,k),g(e,a),h(C,r,k),h(C,n,k),g(n,o),g(o,i),g(i,u),g(o,s),re(c,o,null),g(n,l),g(n,w),g(w,b),g(b,f),g(b,m),g(b,d),g(w,N),g(w,p),Ie(p,t[3]),g(w,x),P&&P.m(w,null),g(w,q),L&&L.m(w,null),g(w,M),j&&j.m(w,null),g(w,y),g(w,F),g(F,$),g(n,te),g(n,D),g(D,ge),K=!0,we||(Te=[U(e,"click",t[11]),U(p,"input",t[12]),U(p,"change",t[13]),U(F,"click",G(t[17])),U(n,"submit",G(t[9]))],we=!0)},p(C,k){(!K||k&64)&&J(m,C[6]),(!K||k&64)&&E(p,"max",C[6]),k&8&&Ke(p.value)!==C[3]&&Ie(p,C[3]),C[6]>=10?P?P.p(C,k):(P=He(C),P.c(),P.m(w,q)):P&&(P.d(1),P=null),C[6]>=20?L?L.p(C,k):(L=We(C),L.c(),L.m(w,M)):L&&(L.d(1),L=null),C[6]>=40?j?j.p(C,k):(j=Ve(C),j.c(),j.m(w,y)):j&&(j.d(1),j=null)},i(C){K||(B(c.$$.fragment,C),K=!0)},o(C){H(c.$$.fragment,C),K=!1},d(C){C&&v(e),C&&v(r),C&&v(n),ie(c),P&&P.d(),L&&L.d(),j&&j.d(),we=!1,Ge(Te)}}}function Da(t){let e,a,r=t[5],n=[];for(let i=0;i<r.length;i+=1)n[i]=Je(ye(t,r,i));const o=i=>H(n[i],1,1,()=>{n[i]=null});return{c(){for(let i=0;i<n.length;i+=1)n[i].c();e=Q()},l(i){for(let u=0;u<n.length;u+=1)n[u].l(i);e=Q()},m(i,u){for(let s=0;s<n.length;s+=1)n[s]&&n[s].m(i,u);h(i,e,u),a=!0},p(i,u){if(u&52){r=i[5];let s;for(s=0;s<r.length;s+=1){const c=ye(i,r,s);n[s]?(n[s].p(c,u),B(n[s],1)):(n[s]=Je(c),n[s].c(),B(n[s],1),n[s].m(e.parentNode,e))}for(fe(),s=r.length;s<n.length;s+=1)o(s);be()}},i(i){if(!a){for(let u=0;u<r.length;u+=1)B(n[u]);a=!0}},o(i){n=n.filter(Boolean);for(let u=0;u<n.length;u+=1)H(n[u]);a=!1},d(i){pe(n,i),i&&v(e)}}}function Oa(t){let e,a,r;const n=[t[22],{index:t[24]}];function o(u){t[19](u)}let i={};for(let u=0;u<n.length;u+=1)i=Ce(i,n[u]);return t[2]!==void 0&&(i.showAnswers=t[2]),e=new Radio({props:i}),Ye.push(()=>Xe(e,"showAnswers",o)),{c(){ee(e.$$.fragment)},l(u){ae(e.$$.fragment,u)},m(u,s){re(e,u,s),r=!0},p(u,s){const c=s&1?Se(n,[Ae(u[22]),n[1]]):{};!a&&s&4&&(a=!0,c.showAnswers=u[2],Qe(()=>a=!1)),e.$set(c)},i(u){r||(B(e.$$.fragment,u),r=!0)},o(u){H(e.$$.fragment,u),r=!1},d(u){ie(e,u)}}}function Ia(t){let e,a,r;const n=[t[22],{index:t[24]}];function o(u){t[18](u)}let i={};for(let u=0;u<n.length;u+=1)i=Ce(i,n[u]);return t[2]!==void 0&&(i.showAnswers=t[2]),e=new Checkbox({props:i}),Ye.push(()=>Xe(e,"showAnswers",o)),{c(){ee(e.$$.fragment)},l(u){ae(e.$$.fragment,u)},m(u,s){re(e,u,s),r=!0},p(u,s){const c=s&1?Se(n,[Ae(u[22]),n[1]]):{};!a&&s&4&&(a=!0,c.showAnswers=u[2],Qe(()=>a=!1)),e.$set(c)},i(u){r||(B(e.$$.fragment,u),r=!0)},o(u){H(e.$$.fragment,u),r=!1},d(u){ie(e,u)}}}function Fe(t){let e,a,r,n;const o=[Ia,Oa],i=[];function u(s,c){return s[22].correct_answers.length>1?0:1}return e=u(t),a=i[e]=o[e](t),{c(){a.c(),r=Q()},l(s){a.l(s),r=Q()},m(s,c){i[e].m(s,c),h(s,r,c),n=!0},p(s,c){let l=e;e=u(s),e===l?i[e].p(s,c):(fe(),H(i[l],1,1,()=>{i[l]=null}),be(),a=i[e],a?a.p(s,c):(a=i[e]=o[e](s),a.c()),B(a,1),a.m(r.parentNode,r))},i(s){n||(B(a),n=!0)},o(s){H(a),n=!1},d(s){i[e].d(s),s&&v(r)}}}function Ue(t){let e,a;return{c(){e=_("button"),a=A("Submit form"),this.h()},l(r){e=z(r,"BUTTON",{type:!0,class:!0});var n=S(e);a=T(n,"Submit form"),n.forEach(v),this.h()},h(){E(e,"type","submit"),E(e,"class","submit-btn svelte-n1kvot")},m(r,n){h(r,e,n),g(e,a)},d(r){r&&v(e)}}}function ke(t){let e,a,r,n,o,i=t[3]-t[7]+"",u,s,c,l,w;return{c(){e=_("button"),a=A("Genereaza inca un quizz"),r=O(),n=_("h4"),o=A("Ai nimerit "),u=A(i),s=A(" din "),c=A(t[3]),this.h()},l(b){e=z(b,"BUTTON",{type:!0,class:!0,style:!0});var f=S(e);a=T(f,"Genereaza inca un quizz"),f.forEach(v),r=I(b),n=z(b,"H4",{style:!0});var m=S(n);o=T(m,"Ai nimerit "),u=T(m,i),s=T(m," din "),c=T(m,t[3]),m.forEach(v),this.h()},h(){E(e,"type","button"),E(e,"class","submit-btn svelte-n1kvot"),R(e,"position","sticky"),R(e,"bottom","20px"),R(n,"position","absolute"),R(n,"bottom","0"),R(n,"right","0"),R(n,"background-color","grey"),R(n,"padding","10px 20px"),R(n,"color","white"),R(n,"font-weight","600"),R(n,"font-size","20px")},m(b,f){h(b,e,f),g(e,a),h(b,r,f),h(b,n,f),g(n,o),g(n,u),g(n,s),g(n,c),l||(w=U(e,"click",t[20]),l=!0)},p(b,f){f&136&&i!==(i=b[3]-b[7]+"")&&J(u,i),f&8&&J(c,b[3])},d(b){b&&v(e),b&&v(r),b&&v(n),l=!1,w()}}}function He(t){let e,a,r,n;return{c(){e=_("button"),a=A("select 10"),this.h()},l(o){e=z(o,"BUTTON",{class:!0});var i=S(e);a=T(i,"select 10"),i.forEach(v),this.h()},h(){E(e,"class","input-btn svelte-n1kvot")},m(o,i){h(o,e,i),g(e,a),r||(n=U(e,"click",G(t[14])),r=!0)},p:V,d(o){o&&v(e),r=!1,n()}}}function We(t){let e,a,r,n;return{c(){e=_("button"),a=A("select 20"),this.h()},l(o){e=z(o,"BUTTON",{class:!0});var i=S(e);a=T(i,"select 20"),i.forEach(v),this.h()},h(){E(e,"class","input-btn svelte-n1kvot")},m(o,i){h(o,e,i),g(e,a),r||(n=U(e,"click",G(t[15])),r=!0)},p:V,d(o){o&&v(e),r=!1,n()}}}function Ve(t){let e,a,r,n;return{c(){e=_("button"),a=A("select 40"),this.h()},l(o){e=z(o,"BUTTON",{class:!0});var i=S(e);a=T(i,"select 40"),i.forEach(v),this.h()},h(){E(e,"class","input-btn svelte-n1kvot")},m(o,i){h(o,e,i),g(e,a),r||(n=U(e,"click",G(t[16])),r=!0)},p:V,d(o){o&&v(e),r=!1,n()}}}function Je(t){let e,a;const r=[t[22],{index:t[24]},{showAnswers:t[2]},{generateAnswered:t[4]}];let n={};for(let o=0;o<r.length;o+=1)n=Ce(n,r[o]);return e=new Ea({props:n}),{c(){ee(e.$$.fragment)},l(o){ae(e.$$.fragment,o)},m(o,i){re(e,o,i),a=!0},p(o,i){const u=i&52?Se(r,[i&32&&Ae(o[22]),r[1],i&4&&{showAnswers:o[2]},i&16&&{generateAnswered:o[4]}]):{};e.$set(u)},i(o){a||(B(e.$$.fragment,o),a=!0)},o(o){H(e.$$.fragment,o),a=!1},d(o){ie(e,o)}}}function Ra(t){let e,a,r,n;const o=[Da,xa,ha],i=[];function u(s,c){return s[4]?0:s[1]?2:1}return e=u(t),a=i[e]=o[e](t),{c(){a.c(),r=Q()},l(s){a.l(s),r=Q()},m(s,c){i[e].m(s,c),h(s,r,c),n=!0},p(s,[c]){let l=e;e=u(s),e===l?i[e].p(s,c):(fe(),H(i[l],1,1,()=>{i[l]=null}),be(),a=i[e],a?a.p(s,c):(a=i[e]=o[e](s),a.c()),B(a,1),a.m(r.parentNode,r))},i(s){n||(B(a),n=!0)},o(s){H(a),n=!1},d(s){i[e].d(s),s&&v(r)}}}function Pa(t,e,a){let r,n,o;X(t,_e,D=>a(21,r=D)),X(t,Ee,D=>a(6,n=D)),X(t,ze,D=>a(7,o=D));let i=Z;const u=["random","algoritmi_structuri_date","baze_de_date","cloud_computing","comert_electronic","criptografie","programare_in_c","programare_in_java","programare_procedurala","retele_de_calculatoare","sgbd","sisteme_de_operare","tehnici_avansate_programare","tehnologii_web"];let s=!1,c=!1,l=1;function w(){if(r==="random"){a(0,i=Ne(Z,l)),a(1,s=!0);return}a(0,i=ce(r)),a(0,i=Ne(i,l)),a(1,s=!0)}function b(D){a(2,c=!0)}let f=!1,m;function d(){a(0,i=ce(r)),a(5,m=Ne(i,i.length,!1)),a(4,f=!0),a(2,c=!0)}function N(){l=Ke(this.value),a(3,l)}const p=()=>fa.set(l),x=()=>a(3,l=10),q=()=>a(3,l=20),M=()=>a(3,l=40),y=()=>a(3,l=n);function F(D){c=D,a(2,c)}function $(D){c=D,a(2,c)}return[i,s,c,l,f,m,n,o,u,w,b,d,N,p,x,q,M,y,F,$,()=>{a(2,c=!1),a(1,s=!1),ze.update(D=>0)}]}class Ba extends le{constructor(e){super(),me(this,e,Pa,Ra,de,{})}}export{Ba as default};
